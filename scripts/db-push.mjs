...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS "PlayerUnderlyingSnapshot" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "playerId" INTEGER NOT NULL, "source" TEXT NOT NULL, "sourcePlayerId" TEXT NOT NULL, "capturedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "games" INTEGER NOT NULL DEFAULT 0, "minutes" INTEGER NOT NULL DEFAULT 0, "goals" INTEGER NOT NULL DEFAULT 0, "assists" INTEGER NOT NULL DEFAULT 0, "expectedGoals" REAL NOT NULL DEFAULT 0, "expectedAssists" REAL NOT NULL DEFAULT 0, "nonPenaltyExpectedGoals" REAL NOT NULL DEFAULT 0, "shots" INTEGER NOT NULL DEFAULT 0, "keyPasses" INTEGER NOT NULL DEFAULT 0, "xgPer90" REAL NOT NULL DEFAULT 0, "xaPer90" REAL NOT NULL DEFAULT 0, "rawPayload" TEXT NOT NULL DEFAULT '{}');`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "PlayerUnderlyingSnapshot_identity_idx" ON "PlayerUnderlyingSnapshot" ("playerId", "source", "sourcePlayerId", "capturedAt");`,
  `CREATE INDEX IF NOT EXISTS "PlayerUnderlyingSnapshot_playerId_source_capturedAt_idx" ON "PlayerUnderlyingSnapshot" ("playerId", "source", "capturedAt");`,
  `CREATE TABLE IF NOT EXISTS "TeamMarketSnapshot" ("id" INTEGER PRIMARY KEY AUTOINCREMENT, "source" TEXT NOT NULL, "externalEventId" TEXT NOT NULL, "capturedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, "kickoff" DATETIME, "homeTeam" TEXT NOT NULL, "awayTeam" TEXT NOT NULL, "homeWinProb" REAL, "drawProb" REAL, "awayWinProb" REAL, "homeGoals" REAL, "awayGoals" REAL, "rawPayload" TEXT NOT NULL DEFAULT '{}');`,
  `CREATE UNIQUE INDEX IF NOT EXISTS "TeamMarketSnapshot_identity_idx" ON "TeamMarketSnapshot" ("source", "externalEventId", "capturedAt");`,
  `CREATE INDEX IF NOT EXISTS "TeamMarketSnapshot_teams_kickoff_idx" ON "TeamMarketSnapshot" ("homeTeam", "awayTeam", "kickoff");`,
  ...
  `CREATE TABLE IF NOT EXISTS "UserPreference" ("id" TEXT PRIMARY KEY DEFAULT 'default', "userName" TEXT NOT NULL DEFAULT '', "selectedIds" TEXT NOT NULL DEFAULT '[]', "lockedIds" TEXT NOT NULL DEFAULT '[]', "bank" REAL, "freeTransfers" INTEGER NOT NULL DEFAULT 1, "defaultLeagueId" INTEGER, "onboardingCompleted" BOOLEAN NOT NULL DEFAULT 0, "challengeResult" TEXT, "stagedReviews" TEXT NOT NULL DEFAULT '{}', "updatedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP);`
]
